...
const response = await fetch("http://api.wolframalpha.com/v2/query?appid="+process.env.WOLFRAMALPHA_KEY+"&solve="+ligningData+"&%3D11&podstate=Result__Step-by-step+solution&format=plaintext")
